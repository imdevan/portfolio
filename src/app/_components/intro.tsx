...
export function Intro() {
  return (
    <section className="flex-col flex items-center md:justify-between mb-32 mt-24 md:mt-32 max-w-6xl mx-auto w-full overflow-x-hidden overflow-y-hidden bg-transparent">
      <AnimateIn>
