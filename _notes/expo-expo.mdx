---
title: '“Expo! Expo!”'
subtitle: 'A React Native Jump Starter Kit'
...
Lately, I've been itching to dive into **React Native**. I’ve built plenty of web apps with **Next.js, TypeScript, and Tailwind**, but I wanted to expand my skillset into mobile development. The problem? Most React Native starter templates aren’t **production-ready**. They give you the basics but leave you doing a ton of extra work just to get something deployable.
...
Check out the full roadmap [here](https://github.com/imdevan/expo-expo).

## 🎯 The Goal

By building **Expo Expo**, I’m killing two birds with one stone:
1. **Learning React Native** the hands-on way
2. **Jump-starting another React Native project** I’ve been wanting to build

If this sounds like something useful to you, feel free to check out the repo and contribute! 🚀

👉 **[GitHub Repo: imdevan/expo-expo](https://github.com/imdevan/expo-expo)**
